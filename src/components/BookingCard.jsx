...
return (
<div className="bg-[#0e1729]/70 backdrop-blur-md border border-blue-800 rounded-2xl p-6 shadow-lg hover:shadow-blue-600/30 hover:scale-[1.02] transition-all duration-300" data-aos="fade-up" >
{/* Mentor Info */}
<div className="flex items-center gap-4 mb-4">
<Image src={booking.mentorImage} alt={booking.mentorName} width={50} height={50} className="rounded-full object-cover" />
<div>
...
<p className="text-sm text-gray-400">{booking.subject}</p>
  ...
  <div className="space-y-2 text-sm">
    <p className="flex items-center gap-2 text-gray-300">
      <FaCalendarAlt className="text-blue-400" /> {booking.dateTime}
    </p>
    <p className="flex items-center gap-2 text-gray-300">
      <FaClock className="text-blue-400" /> {booking.duration}
    </p>
    <p className="flex items-center gap-2 text-gray-300">
  ...
  {/* Status Badge */}
  <span
    className={`inline-block px-3 py-1 rounded-full text-xs font-semibold mt-5 ${statusColors[booking.status]}`}
  >
