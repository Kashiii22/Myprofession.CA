...
const PricingStep = ({ onNext, onBack, initialData }) => {
  const defaultPricing = [{ type: "chat", price: 10, enabled: false, description: "Live text-based mentoring." },{ type: "video", price: 30, enabled: false, description: "Face-to-face video call." },];
